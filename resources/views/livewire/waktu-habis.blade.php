            ...
            <div class="p-4 bg-red-50 border-l-4 border-red-500 rounded-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-red-700">Ada masalah saat menilai jawaban essay. Silakan hubungi
                            pengajar.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-green-700">Semua jawaban telah dinilai. Anda dapat melihat hasilnya
                            sekarang.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700">Beberapa jawaban sudah dinilai, yang lain masih dalam proses
                        </p>
                    </div>
                </div>
                <button wire:click="refreshStatus"
