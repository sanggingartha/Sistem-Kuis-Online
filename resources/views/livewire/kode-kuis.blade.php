    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
                ...
                @if ($kuis)
                    <div class="p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border-2 border-purple-200 mb-4">
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-purple-800"><strong>Waktu:</strong> {{ $kuis->waktu_pengerjaan }} menit</span>
                            </div>
                            <div class="flex items-center text-sm">
                                <svg class="w-4 h-4 text-purple-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span class="text-purple-800"><strong>Status:</strong> <span class="font-semibold capitalize">{{ ucfirst($kuis->status) }}</span></span>
                            </div>
                            <div class="flex items-center text-sm">
                                <svg class="w-4 h-4 text-purple-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-purple-800"><strong>Berakhir:</strong> {{ $kuis->berakhir_pada }}</span>
                            </div>
                        </div>

                        <!-- Button Mulai Kuis -->
                        <button 
                            wire:click="mulaiKuis"
                ...
                <div class="mt-4 p-3 bg-purple-50 rounded-xl border border-purple-100">
                    <div class="flex items-start">
                        ...
                        <p class="text-xs text-purple-700">
                            Masukkan kode kuis yang diberikan oleh pengajar untuk memulai kuis atau scan QR Code yang tersedia.
                        </p>
                    </div>
                </div>
            </div>
