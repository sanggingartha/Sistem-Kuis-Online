<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 py-12 px-4 flex items-center justify-center">
    <div class="w-full max-w-2xl">
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="p-8 md:p-12 text-center">
                <!-- Icon Success -->
                <div class="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full mb-6 shadow-xl animate-bounce">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <div class="bg-purple-50 rounded-xl p-4 border-2 border-purple-200">
                        ...
                        <p class="text-2xl font-bold text-purple-700">{{ $hasilKuis->jawabanPilihanGanda->count() + $hasilKuis->jawabanEssay->count() }}</p>
                    ...
                    <div class="bg-blue-50 rounded-xl p-4 border-2 border-blue-200">
                        ...
                        <p class="text-2xl font-bold text-blue-700">
                            @if($hasilKuis->durasi_pengerjaan)
                                {{ floor($hasilKuis->durasi_pengerjaan / 60) }} menit
                            @else
                                -
                            @endif
                        </p>
                ...
                @if($hasilKuis->jawabanEssay->count() > 0)
                    <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-8">
                        ...
                        <p class="text-sm text-blue-700 font-medium">
                            {{ $progress['dinilai'] }} dari {{ $progress['total'] }} essay telah dinilai ({{ number_format($progress['persentase'], 0) }}%)
                        </p>
                    </div>
                @endif
