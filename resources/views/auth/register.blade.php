            ...
            <div class="w-full md:w-1/2 bg-white p-10 flex flex-col justify-center">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="flex justify-center mb-6 border border-gray-300 rounded-lg overflow-hidden">
                        ...
                        <button type="button" class="role-btn w-1/2 py-2 font-semibold" data-role="siswa">
                            Siswa
                        </button>
                        <button type="button" class="role-btn w-1/2 py-2 font-semibold" data-role="pengajar">
                            Pengajar
                        </button>
                    </div>
